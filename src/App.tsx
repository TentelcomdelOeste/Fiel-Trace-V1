    ...
    try {
      ...
      (async () => {
        try {
          ...
          // 2. Guardar fotografía en galería nativa de Android / iOS
          const savedToGallerySuccess = await cameraService.saveToGallery(finalImage, fileName);
          if (!savedToGallerySuccess) {
            console.warn("[AtomicCapture] Advertencia: No se pudo confirmar el guardado en la galería nativa, continuando con el registro de evidencia.");
          }
